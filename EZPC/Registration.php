...
<div class="wrapper">
    <main class="main">
        <div id="reg_label">
            <img id="pc_logo" src="img_PCGuide/favicon_small.png" alt = "PC_Logo">
            <h1>Registration</h1>
        </div>
        <div id="reg_data">
            <form id="login_data_form" action="" method="get">
                <p>
                    <label class="text-field__label" for="login">Login:</label>
                    <input class="text-field__input" placeholder="Login" type="text" name="login" id="login" required>
                </p>
                <p>
                    <label class="text-field__label" for="email">Email:</label>
                    <input class="text-field__input" placeholder="Email" type="email" name="email" id="email" required>
                </p>
                <p>
                    <label class="text-field__label" for="tel">Phone:</label>
                    <input class="text-field__input" placeholder="Number" type="tel" name="tel" id="tel" required>
                </p>
                <p>
                ...
                <button class="Reg_btn" type="submit">Confirm</button>
            </form>
        </div>
